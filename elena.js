const key = "elena-balloon-one-shot-v1";
...
function showFailed() {
  ...
  message.textContent = "Blocked. Balloon survived. Elena failed. Buy me a drink for another try 🍹";
}
...
reset.addEventListener("click", () => {
  ...
  balloon.querySelector(".face").textContent = "😌";
  message.textContent = "Balloon intact. Charm levels under review.";
});
