const key = "k-balloon-one-shot-v1";
...
function showFailed() {
  ...
  message.textContent = 'Blocked. Balloon survived. K failed. Buy me a drink to skip work emotionally 🍹';
}
...
reset.addEventListener("click", () => {
  ...
  balloon.querySelector(".face").textContent = "😌";
  message.textContent = 'Balloon intact. Monday survival pending.';
});
